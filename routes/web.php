...
Route::get('/contact-us','SearchController@contact')->name('contact');
Route::post('/contact-submit','SearchController@submit');
...
Route::group(['prefix'=>'admin','middleware'=>['auth','admin']],function (){
    ...
    Route::get('delete-slider-image/{id}','SliderController@deleteImage');
///
});
