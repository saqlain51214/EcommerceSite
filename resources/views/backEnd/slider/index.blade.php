            ...
            <div class="widget-content nopadding">
                <table class="table table-bordered data-table">
                    ...
                    @foreach($sliders as $slider)
                        ...
                        <tr class="gradeC">
                            <td>{{$i}}</td>
                            <td style="text-align: center;"><img src="{{url('slider',$slider->image)}}" alt="" width="50"></td>
                            <td style="text-align: center; vertical-align: middle;">
                                {{$slider->status==1?'Active':'Disable'}}
                            </td>
                            <td style="text-align: center; vertical-align: middle;">
                                <a href="{{route('slider.edit',$slider->id)}}" class="btn btn-primary btn-mini">Edit</a>
                                <a href="javascript:" rel="{{$slider->id}}" rel1="delete-slider-image" class="btn btn-danger btn-mini deleteRecord">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
