...
@section('content')
    <div id="breadcrumb"> <a href="{{url('/admin')}}" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="{{route('slider.index')}}">Slider</a> <a href="{{route('slider.create')}}" class="current">Add New Slider</a> </div>
